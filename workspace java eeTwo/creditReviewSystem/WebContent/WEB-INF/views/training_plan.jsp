...
<script src="resource/js/control.js"></script>
 ...
 <div class="container" id="containerTwo">
	...
	<div class="col-md-8 column">
	       <div class="panel panel-default">
	          <div class="panel-heading">
	            <h3 class="panel-title">当前位置：基础数据管理->教师信息管理</h3>
	          </div>
	...
	<div class="col-md-4 column">
					...
					<form class="form-horizontal" role="form" methond="get" action="#">
					<a href="add_plan" class="btn btn-primary">添加方案</a>
					<form/>
	</div>
</div>
</div>
<div id="updatePlanBTn">
 <a href="update_plan" class="btn btn-primary">修改方案</a>
